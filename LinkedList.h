 ...
 */
extern void LinkedList_add_at_front(LinkedList *list, CSG *value);

/**
 * Add the given void* value at the end of the given LinkedList.
 */
extern void LinkedList_add_at_end(LinkedList *list, CSG *value);

/**
 * Return true if then given LinkedList contains given void* value.
 */
extern bool LinkedList_contains(const LinkedList *list, CSG *value);
 ...
 */
extern void LinkedList_remove(LinkedList *list, CSG *data);
